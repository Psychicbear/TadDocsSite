...
export class Text {
    ...
    set state(newState) {
        ...
        this.colour = newState.textColour;
        ...
        this.rotation = newState.textRotation;
    }
    get state() {
        return {
            //@ts-expect-error
    ...
    _print(x, y, content, maxWidth=this.#maxWidth) {
        ...
        if (maxWidth <= 0) {
            ...
            const oldStroke = this.#tad.context.strokeStyle;
            this.#tad.context.strokeStyle = "transparent";
            this.#tad.context.fillText(content, x, y);
            this.#tad.context.strokeStyle = oldStroke;
    ...
    print(x, y, content) {
        ...
        //         debugmsg = "No wrapping applied";
        //     } else {
        //         Debug.drawText(this.#tad, x, y, content, this.#maxWidth, numOfLines);
        //         debugmsg = `Wrapping applied. ${numOfLines} lines generated.`
        //     }
        // }
        this.#tad.state.load();
