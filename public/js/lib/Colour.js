...
export class Colour {
    ...
    get fill() {
        ...
        console.warn("deprecated colour get fill called!");
        return this.#fill;
    }
    ...
    set fill(value) {
        throw new Error("DEPRECATED");
        console.warn("deprecated colour set fill called!");
    ...
    get stroke() {
        throw new Error("DEPRECATED");
        console.warn("deprecated colour get stroke called!");
        return this.#stroke;
    }
     ...
     */
    set state(newState) {
        console.warn("deprecated colour state called!");
